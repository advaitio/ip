...
public class Nudge {
    ...
    public NudgeResponse getResponse(String command) {
        ...
        if (normalizedCommand.isEmpty()) {
            return NudgeResponse.error("Please enter a command. " + COMMAND_HINT);
        }
        ...
        try {
            ...
            return switch (commandType) {
                ...
                case FIND -> getTaskListResponse(
                        tasks.find(Parser.parseFindKeyword(normalizedCommand)),
                        "Here are the matches I found:");
                case SORT -> {
                    Parser.validateSortCommand(normalizedCommand);
                    yield sortTasks();
                }
                case MARK -> markTask(Parser.parseTaskIndex(normalizedCommand, "mark"));
                case UNMARK -> unmarkTask(Parser.parseTaskIndex(normalizedCommand, "unmark"));
                case DELETE -> deleteTask(Parser.parseTaskIndex(normalizedCommand, "delete"));
